...
const userSchema = new Schema(
  {
    ...
    username: {
      //proteger información del usuario para que no manden spams al correo//
      type: String,
      ...
      validate: {
        //Validación de cualquier criterio que queramos//
        validator: function (value) {
          //no usar en modelos mongoose la función flecha porque no hereda el .this//
...
); //registra la fecha de cuando se creó//
